...
class Rectangle(MarkupAnnotation):
    ...
    def __init__(self, rect: Union[RectangleObject, Tuple[float, float, float, float]], *, interior_color: Optional[str]=None, **kwargs: Any):
...
class Highlight(MarkupAnnotation):
    ...
    def __init__(self, *, rect: Union[RectangleObject, Tuple[float, float, float, float]], quad_points: ArrayObject, highlight_color: str='ff0000', printing: bool=False, **kwargs: Any):
        super().__init__(**kwargs)
